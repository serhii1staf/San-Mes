  ...
  return (
    ...
    >
      <View style={{ position: 'relative' }}>
        <Avatar emoji={notification.userAvatar} name={notification.userName} size="sm" />
        <View
          style={{
            position: 'absolute',
            bottom: -2,
