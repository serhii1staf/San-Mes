...
function TrackCard({ track }: { track: Track }) {
  ...
  return (
    <Pressable onPress={() => { triggerHaptic('light'); play(track); }} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: active ? theme.colors.accent.primary + '15' : (theme.isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.04)'), borderRadius: 16, padding: 8, borderWidth: active ? 1 : 0, borderColor: theme.colors.accent.primary }}>
