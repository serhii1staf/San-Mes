...
const ru: Record<string, string> = {
  ...
  'gif.add.hint': 'Вставьте ссылку. «Скопировать ссылку» из Discord, Giphy или Tenor работает как есть — страница сама разворачивается в гифку. Прямой адрес файла тоже подойдёт.',
  ...
  'gif.add.added': 'Гифка добавлена',
  'gif.add.sources_title': 'Что работает',
  'gif.add.sources_body': '«Скопировать ссылку» из Discord, Giphy и Tenor · файловые ссылки Telegram · любой прямой адрес .gif, .webp или .png.\n\nПо одной гифке за раз. Целый набор стикеров Telegram — это другое: для него нужен официальный Bot API Telegram, он будет отдельно.\n\nЧтобы удалить свою гифку, задержите на ней палец.',
