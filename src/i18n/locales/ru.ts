...
const ru: Record<string, string> = {
  ...
  // English it printed Russian. Several of them were added by recent work on the
  // notification-category screen and the platform-design concept.
  'alerts.title': 'Ð£Ð²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ',
  'alerts.section.push': 'Push-ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ',
  'alerts.push.enabled': 'Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ push-ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ñ',
  'alerts.push.hint': 'Ð’Ñ‹ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ Ð¿Ð¾Ð»Ð½Ð¾ÑÑ‚ÑŒÑŽ Ð¾Ñ‚ÐºÐ»ÑŽÑ‡Ð°ÐµÑ‚ push Ð´Ð»Ñ ÑÑ‚Ð¾Ð³Ð¾ ÑƒÑÑ‚Ñ€Ð¾Ð¹ÑÑ‚Ð²Ð°: Ñ‚Ð¾ÐºÐµÐ½ ÑƒÐ´Ð°Ð»ÑÐµÑ‚ÑÑ, Ð¸ ÑÐµÑ€Ð²ÐµÑ€ Ð¿ÐµÑ€ÐµÑÑ‚Ð°Ñ‘Ñ‚ Ð¸Ñ… Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÑÑ‚ÑŒ.',
  'alerts.section.categories': 'ÐžÐ¿Ð¾Ð²ÐµÑ‰ÐµÐ½Ð¸Ñ Ð² Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ð¸',
  'alerts.categories.hint': 'Ð£Ð¿Ñ€Ð°Ð²Ð»ÑÐµÑ‚ Ð¾Ð¿Ð¾Ð²ÐµÑ‰ÐµÐ½Ð¸ÑÐ¼Ð¸, Ð¿Ð¾ÐºÐ° Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚Ð¾: Ð¿Ð»Ð°ÑˆÐºÐ¾Ð¹ ÑÐ²ÐµÑ€Ñ…Ñƒ, Ð·Ð²ÑƒÐºÐ¾Ð¼ Ð¸ Ð·Ð°Ð¿Ð¸ÑÑŒÑŽ Ð² Ñ†ÐµÐ½Ñ‚Ñ€Ðµ ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹. ÐŸÐ¾ÐºÐ° Ð¿Ñ€Ð¸Ð»Ð¾Ð¶ÐµÐ½Ð¸Ðµ Ð·Ð°ÐºÑ€Ñ‹Ñ‚Ð¾, Ð¿Ð¾ÐºÐ°Ð· Ð±Ð°Ð½Ð½ÐµÑ€Ð° Ñ€ÐµÑˆÐ°ÐµÑ‚ ÑÐ¸ÑÑ‚ÐµÐ¼Ð° â€” Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¾Ñ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¸ ÐµÐ³Ð¾, Ð²Ð¾ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐ¹Ñ‚ÐµÑÑŒ Ð¿ÐµÑ€ÐµÐºÐ»ÑŽÑ‡Ð°Ñ‚ÐµÐ»ÐµÐ¼ Ð²Ñ‹ÑˆÐµ.',
  'chat.link': 'Ð¡ÑÑ‹Ð»ÐºÐ°',
  'chat.reply_label': 'ÐžÑ‚Ð²ÐµÑ‚',
  'profile.message': 'Ð¡Ð¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ',
  'errors.boundary_title': 'Ð§Ñ‚Ð¾-Ñ‚Ð¾ Ð¿Ð¾ÑˆÐ»Ð¾ Ð½Ðµ Ñ‚Ð°Ðº',
  'errors.boundary_body': 'ÐŸÑ€Ð¾Ð¸Ð·Ð¾ÑˆÐ»Ð° Ð½ÐµÐ¿Ñ€ÐµÐ´Ð²Ð¸Ð´ÐµÐ½Ð½Ð°Ñ Ð¾ÑˆÐ¸Ð±ÐºÐ°. ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹Ñ‚Ðµ ÐµÑ‰Ñ‘ Ñ€Ð°Ð·.',
  'errors.boundary_retry': 'ÐŸÐ¾Ð¿Ñ€Ð¾Ð±Ð¾Ð²Ð°Ñ‚ÑŒ ÑÐ½Ð¾Ð²Ð°',
  'mention.not_found_title': 'ÐžÐ¹, Ð¿Ð¾Ñ…Ð¾Ð¶Ðµ, Ñ‚Ð°ÐºÐ¾Ð³Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ Ð½ÐµÑ‚',
  'mention.not_found_body': 'ÐŸÑ€Ð¾Ð²ÐµÑ€ÑŒÑ‚Ðµ Ð¸Ð¼Ñ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ. Ð’Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾, Ð¾Ð½Ð¾ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ð»Ð¾ÑÑŒ Ð¸Ð»Ð¸ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»ÑŒ Ð±Ñ‹Ð» ÑƒÐ´Ð°Ð»Ñ‘Ð½.',
  'settings.chat_settings': 'ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ñ‡Ð°Ñ‚Ð¾Ð²',
  'settings.stickers': 'Ð¡Ñ‚Ð¸ÐºÐµÑ€Ñ‹',
  'settings.platform_design': 'ÐœÐ°Ñ‚ÐµÑ€Ð¸Ð°Ð» Ð¿Ð»Ð°Ñ‚Ñ„Ð¾Ñ€Ð¼Ñ‹',
  'settings.section.chats': 'Ð§Ð°Ñ‚Ñ‹',
  'settings.section.data': 'Ð”Ð°Ð½Ð½Ñ‹Ðµ Ð¸ ÑƒÑÑ‚Ñ€Ð¾Ð¹ÑÑ‚Ð²Ð¾',
  'settings.section.legal': 'ÐŸÑ€Ð°Ð²Ð¾Ð²Ð°Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ',
  'design_lab.title': 'ÐœÐ°Ñ‚ÐµÑ€Ð¸Ð°Ð» Ð¿Ð»Ð°Ñ‚Ñ„Ð¾Ñ€Ð¼Ñ‹',
  'design_lab.section.nav': 'ÐÐ¸Ð¶Ð½ÑÑ Ð½Ð°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ñ',
  'design_lab.section.buttons': 'ÐšÐ½Ð¾Ð¿ÐºÐ¸',
  'design_lab.section.depth': 'Ð“Ð»ÑƒÐ±Ð¸Ð½Ð°',
  'design_lab.glass_hint': 'ÐŸÐ¾Ñ‚ÑÐ½Ð¸ Ñ„Ð¾Ð½ Ð² ÑÑ‚Ð¾Ñ€Ð¾Ð½Ñƒ',
  'design_lab.note.ios': 'ÐŸÐ¾Ð²ÐµÑ€Ñ…Ð½Ð¾ÑÑ‚ÑŒ â€” ÑÑ‚Ð¾ Ð»Ð¸Ð½Ð·Ð°. ÐžÐ½Ð° Ð¿Ñ€Ð¾Ð¿ÑƒÑÐºÐ°ÐµÑ‚ Ð¸ Ñ€Ð°Ð·Ð¼Ñ‹Ð²Ð°ÐµÑ‚ Ñ‚Ð¾, Ñ‡Ñ‚Ð¾ Ð·Ð° Ð½ÐµÐ¹, Ð³Ð»ÑƒÐ±Ð¸Ð½Ð° Ð²Ð¾Ð·Ð½Ð¸ÐºÐ°ÐµÑ‚ Ð¸Ð· ÑÑ‚Ð¾Ð¹ Ð¾Ð¿Ñ‚Ð¸ÐºÐ¸. Ð’Ñ‹Ð±Ð¾Ñ€ Ð¿Ð¾ÐºÐ°Ð·Ð°Ð½ Ñ†Ð²ÐµÑ‚Ð¾Ð¼, Ð° Ð½Ðµ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð¾Ð¼; Ð´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ðµ â€” ÐºÑ€Ð¸Ð²Ð°Ñ, Ð° Ð½Ðµ Ð¿Ñ€ÑƒÐ¶Ð¸Ð½Ð°.',
  'design_lab.note.android': 'ÐŸÐ¾Ð²ÐµÑ€Ñ…Ð½Ð¾ÑÑ‚ÑŒ â€” ÑÑ‚Ð¾ Ñ‚Ð¾Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ð°Ñ Ð±ÑƒÐ¼Ð°Ð³Ð°. Ð“Ð»ÑƒÐ±Ð¸Ð½Ð° Ð·Ð°Ð´Ð°Ñ‘Ñ‚ÑÑ Ñ‚Ð¾Ð½Ð¾Ð¼ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð°, Ð° Ð½Ðµ Ñ€Ð°Ð·Ð¼Ñ‹Ñ‚Ð¸ÐµÐ¼ Ñ„Ð¾Ð½Ð°. Ð’Ñ‹Ð±Ð¾Ñ€ Ð¿Ð¾ÐºÐ°Ð·Ð°Ð½ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð¾Ð¼-Ð¿Ð¸Ð»ÑŽÐ»ÐµÐ¹, Ð½Ð°Ð¶Ð°Ñ‚Ð¸Ðµ Ð¼ÐµÐ½ÑÐµÑ‚ Ñ€Ð°Ð´Ð¸ÑƒÑ ÑÐºÑ€ÑƒÐ³Ð»ÐµÐ½Ð¸Ñ, Ð¼Ð¾Ñ‚Ð¾Ñ€Ð¸ÐºÐ° Ð¿Ñ€ÑƒÐ¶Ð¸Ð½Ð½Ð°Ñ.',
  'design_lab.note.iosbtn': 'ÐšÐ°Ð¿ÑÑƒÐ»Ð° Ð¸Ð· ÑÑ‚ÐµÐºÐ»Ð°: Ñ„Ð¾Ñ€Ð¼Ð° Ð¿Ð¾ÑÑ‚Ð¾ÑÐ½Ð½Ð°, Ð¾Ñ‚ÐºÐ»Ð¸Ðº â€” Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ Ð¿Ñ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚Ð¸ Ð¸ Ð»Ñ‘Ð³ÐºÐ¸Ð¹ Ð¼Ð°ÑÑˆÑ‚Ð°Ð±.',
  'design_lab.note.morph': 'ÐÐ°Ð¶Ð¼Ð¸ Ð¸ Ð¿Ð¾Ð´ÐµÑ€Ð¶Ð¸: Ñ€Ð°Ð´Ð¸ÑƒÑ ÑÐºÑ€ÑƒÐ³Ð»ÐµÐ½Ð¸Ñ ÑƒÐµÐ·Ð¶Ð°ÐµÑ‚ Ð¾Ñ‚ Ð¿Ð¸Ð»ÑŽÐ»Ð¸ Ðº Ð¿Ð¾Ñ‡Ñ‚Ð¸ ÐºÐ²Ð°Ð´Ñ€Ð°Ñ‚Ñƒ Ð¸ Ð¿Ñ€ÑƒÐ¶Ð¸Ð½Ð¾Ð¹ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÑ‚ÑÑ. Ð­Ñ‚Ð¾ Ð¸ ÐµÑÑ‚ÑŒ shape morphing â€” Ð³Ð»Ð°Ð²Ð½Ñ‹Ð¹ Ð¿Ñ€Ð¸Ð·Ð½Ð°Ðº Expressive, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð½ÐµÐ»ÑŒÐ·Ñ ÑƒÐ²Ð¸Ð´ÐµÑ‚ÑŒ Ð½Ð° ÑÐºÑ€Ð¸Ð½ÑˆÐ¾Ñ‚Ðµ.',
  'design_lab.note.lens': 'Ð¡Ñ‚ÐµÐºÐ»Ð¾ â€” ÑÑ‚Ð¾ Ð»Ð¸Ð½Ð·Ð°, Ð¸ Ð²ÑÑ ÐµÐ³Ð¾ ÑÑƒÑ‚ÑŒ Ð² Ñ‚Ð¾Ð¼, Ñ‡Ñ‚Ð¾ Ð·Ð° Ð½Ð¸Ð¼. ÐŸÐ¾ÑÑ‚Ð¾Ð¼Ñƒ Ð¿Ð¾Ñ‚ÑÐ½Ð¸ Ð¿Ð¾Ð»Ð¾ÑÑƒ Ñ Ñ†Ð²ÐµÑ‚Ð°Ð¼Ð¸: Ð¾Ð½Ð° ÐµÐ´ÐµÑ‚, ÑÑ‚ÐµÐºÐ»Ð¾ ÑÑ‚Ð¾Ð¸Ñ‚. Ð“Ð»ÑƒÐ±Ð¸Ð½Ð° Ð½Ð° iOS Ñ‡Ð¸Ñ‚Ð°ÐµÑ‚ÑÑ Ð¸Ð· Ð½Ð°Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ ÑÐ»Ð¾Ñ‘Ð², Ð° Ð½Ðµ Ð¸Ð· Ñ‚Ð¾Ð½Ð° â€” ÑÐ¼Ð¾Ñ‚Ñ€Ð¸ ÑƒÐ³Ð¾Ð», Ð³Ð´Ðµ Ð´Ð²Ð° ÑÑ‚ÐµÐºÐ»Ð° Ð¿ÐµÑ€ÐµÑÐµÐºÐ°ÑŽÑ‚ÑÑ.',
  'design_lab.note.tonal': 'ÐŸÑÑ‚ÑŒ ÑƒÑ€Ð¾Ð²Ð½ÐµÐ¹ â€” ÑÑ‚Ð¾ Ð¿ÑÑ‚ÑŒ Ñ‚Ð¾Ð½Ð¾Ð² Ð¾Ð´Ð½Ð¾Ð¹ Ð¿Ð¾Ð²ÐµÑ€Ñ…Ð½Ð¾ÑÑ‚Ð¸, Ð²Ð»Ð¾Ð¶ÐµÐ½Ð½Ñ‹Ñ… Ð´Ñ€ÑƒÐ³ Ð² Ð´Ñ€ÑƒÐ³Ð°. Ð ÑÐ´Ð¾Ð¼ Ð¾Ð½Ð¸ Ð¿Ð¾Ñ‡Ñ‚Ð¸ Ð½ÐµÑ€Ð°Ð·Ð»Ð¸Ñ‡Ð¸Ð¼Ñ‹, Ð¿Ð¾ÑÑ‚Ð¾Ð¼Ñƒ M3 Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÑ‚ Ð¸Ñ… Ð²Ð»Ð¾Ð¶ÐµÐ½Ð½Ð¾: ÑÐ¾ÑÐµÐ´Ð½Ð¸Ð¹ Ñ‚Ð¾Ð½ ÑÑ‚Ð¾Ð¸Ñ‚ Ð¿Ñ€ÑÐ¼Ð¾ Ð¿Ð¾ Ð³Ñ€Ð°Ð½Ð¸Ñ†Ðµ. Ð¢Ð¾Ð½ â€” Ð¼ÐµÑ…Ð°Ð½Ð¸Ð·Ð¼ Ð´Ð»Ñ Ð»ÐµÐ¶Ð°Ñ‰Ð¸Ñ… Ð¿Ð¾Ð²ÐµÑ€Ñ…Ð½Ð¾ÑÑ‚ÐµÐ¹, Ð¸ Ð¾Ð½ Ð¾ÑÐ¾Ð±ÐµÐ½Ð½Ð¾ Ð²Ñ‹Ð¸Ð³Ñ€Ñ‹Ð²Ð°ÐµÑ‚ Ð² Ñ‚Ñ‘Ð¼Ð½Ð¾Ð¹ Ñ‚ÐµÐ¼Ðµ, Ð³Ð´Ðµ Ñ‚ÐµÐ½ÑŒ Ð¿Ñ€Ð¾Ð¿Ð°Ð´Ð°ÐµÑ‚. ÐÐ¾ Ñ‚ÐµÐ½ÑŒ Ð² M3 ÐµÑÑ‚ÑŒ: Ð´Ð»Ñ Ð´ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ‚ÐµÐ»ÑŒÐ½Ð¾ Ð¿Ð°Ñ€ÑÑ‰Ð¸Ñ… ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð² Ñ‚Ð¾Ð½ Ð´Ð¾Ð¿Ð¾Ð»Ð½ÑÑŽÑ‚ Ñ‚ÐµÐ½ÑŒÑŽ â€” ÑÑ‚Ð¾ Ð´Ð²Ðµ ÐºÐ°Ñ€Ñ‚Ð¾Ñ‡ÐºÐ¸ Ð²Ð½Ð¸Ð·Ñƒ.',
  'design_lab.limit': 'Ð¦Ð²ÐµÑ‚Ð° Ð½Ð° ÑÑ‚Ð¾Ñ€Ð¾Ð½Ðµ Android â€” ÑÑ‚Ð¾ Ð±Ð°Ð·Ð¾Ð²Ð°Ñ Ð¿Ð°Ð»Ð¸Ñ‚Ñ€Ð° Material 3. ÐÐ°ÑÑ‚Ð¾ÑÑ‰Ð¸Ð¹ Material You Ð²Ñ‹Ð²Ð¾Ð´Ð¸Ñ‚ Ð¿Ð°Ð»Ð¸Ñ‚Ñ€Ñƒ Ð¸Ð· Ð¾Ð±Ð¾ÐµÐ² ÑƒÑÑ‚Ñ€Ð¾Ð¹ÑÑ‚Ð²Ð° (Android 12+), Ð´Ð»Ñ Ñ‡ÐµÐ³Ð¾ Ð½ÑƒÐ¶ÐµÐ½ Ð½Ð°Ñ‚Ð¸Ð²Ð½Ñ‹Ð¹ Ð¼Ð¾Ð´ÑƒÐ»ÑŒ Ð¸ Ð½Ð¾Ð²Ð°Ñ ÑÐ±Ð¾Ñ€ÐºÐ° â€” Ð¿Ð¾ OTA ÑÑ‚Ð¾ Ð½Ðµ Ð´Ð¾ÑÑ‚Ð°Ð²Ð»ÑÐµÑ‚ÑÑ. Ð¤Ð¾Ñ€Ð¼Ñ‹, ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ñ‹, Ñ€Ð°Ð·Ð¼ÐµÑ€Ñ‹ Ð¸ Ð¼Ð¾Ñ‚Ð¾Ñ€Ð¸ÐºÐ° Ð·Ð´ÐµÑÑŒ Ð½Ð°ÑÑ‚Ð¾ÑÑ‰Ð¸Ðµ, Ð·Ð°Ñ„Ð¸ÐºÑÐ¸Ñ€Ð¾Ð²Ð°Ð½Ñ‹ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð¾Ñ‚Ñ‚ÐµÐ½ÐºÐ¸.',
};
