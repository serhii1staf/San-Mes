...
const ru: Record<string, string> = {
  ...
  'gif.add.hint': 'Вставьте прямую ссылку на гифку или картинку. Работает с Telegram, Giphy, Tenor и всем остальным, откуда можно скопировать адрес файла. Чтобы удалить свою гифку, задержите на ней палец.',
  'gif.add.placeholder': 'https://…',
  'gif.add.paste': 'Вставить',
  'gif.add.action': 'Добавить',
  'gif.add.err_https': 'Ссылка должна начинаться с https://',
  'gif.add.err_not_media': 'Похоже, это страница, а не картинка. Откройте её, скопируйте адрес самого изображения и вставьте его.',
