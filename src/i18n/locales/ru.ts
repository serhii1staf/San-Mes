...
const ru: Record<string, string> = {
  ...
  'devices.subtitle': 'Устройства, которые получают уведомления на этом аккаунте',
  'devices.note': 'Это не журнал входов. Устройство появляется здесь, когда разрешает уведомления, и исчезает при выходе из аккаунта.',
  'devices.empty': 'Пока ни одного устройства',
  'devices.empty_hint': 'Устройство появится здесь, как только разрешит уведомления',
  'devices.this_device': 'Это устройство',
  'devices.registered': 'Добавлено {date}',
  'devices.registered_unknown': 'Дата неизвестна',
  ...
  'devices.revoke_msg': 'Оно перестанет получать уведомления. Сам аккаунт останется на нём — выйти из аккаунта это не заставит.',
  'devices.revoke_current_msg': 'Это устройство, на котором ты сейчас. Уведомления на нём выключатся, пока ты не включишь их снова в настройках.',
