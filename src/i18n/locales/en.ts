...
const en: Record<string, string> = {
  ...
  'common.close': 'Close',
  'common.open': 'Open',
  'mini_app.external_link_title': 'Open external link?',
  'mini_app.external_link_message': 'Open {url} outside the app?',
  'mini_app.blocked_download_title': 'Download blocked',
  'mini_app.blocked_download_message': "This link points to a file that can't be opened safely in the app.",
  'mini_app.leaving_origin_title': 'Leave this app?',
  'mini_app.leaving_origin_message': 'This is trying to open {host}, which is outside the app.',
  'common.back': 'Back',
  'common.done': 'Done',
  'common.ok': 'OK',
  'common.retry': 'Retry',
  ...
  'settings.profile_theme': 'Profile theme',
  'profileTheme.title': 'Profile theme',
  'profileTheme.save_error': 'Could not save theme',
  ...
  'notifications.section.featured': 'Highlights',
  ...
  'gif.add.err_pack_not_found': 'That sticker pack could not be found. Check the link, or the pack may be private.',
  'gif.add.err_pack_not_configured': 'Sticker pack import is not set up on the server yet.',
  'gif.add.added': 'Added',
  'gif.add.found_one': 'Found 1 GIF',
  'gif.add.found_pack': 'Found {n} stickers · {title}',
  'gif.add.animated_note': 'This pack is animated. Telegram stores those in a format we cannot play yet, so they import as still images.',
  ...
  'customize.draw_done': 'Done',
  'customize.draw_size': 'Brush size',
  'customize.draw_brush': 'Brush',
  'customize.draw_all_colors': 'All colors',
  'customize.draw_erase_hint': 'Tap on lines to erase.',
  'customize.brush_pen': 'Pen',
  'customize.brush_marker': 'Marker',
  'customize.brush_neon': 'Neon',
  'customize.brush_dashed': 'Dashed',
  'customize.anim_none': 'None',
  'customize.anim_float': 'Float',
  'customize.anim_pulse': 'Pulse',
  'customize.anim_spin': 'Spin',
  'customize.anim_swing': 'Swing',
  ...
  'messages.reorder.hint': 'Hold and drag to reorder',
  ...
  'chat.photos.title': 'Photos',
  'chat.photos.system': 'Gallery',
  'chat.photos.permission': 'No photo library access. You can still pick photos with the system gallery.',
  'chat.photos.empty': 'No photos',
  ...
  'screenshot.blocked': 'This account has screenshots turned off',
  'settings.screenshots_disabled': 'Disable screenshots of my profile & chats',
  'settings.screenshots_disabled_desc': 'When on, others get a black screen if they try to screenshot or record your profile and chats with you (full block on Android; recording block + screenshot alert on iOS).',
  ...
  'mini_apps.consent.title': 'Content policy',
  'mini_apps.consent.intro': 'Before publishing, confirm your mini app follows our content rules.',
  'mini_apps.consent.prohibited_heading': 'Prohibited content',
  'mini_apps.consent.prohibited_body': 'You may not publish mini apps with prohibited content.',
  'mini_apps.consent.stores': 'Prohibited content includes anything not allowed by Apple App Store and Google Play policies.',
  'mini_apps.consent.san_policies': "It also includes content that violates San's Terms of Use and Privacy Policy.",
  'mini_apps.consent.terms_link': 'Terms of Use',
  'mini_apps.consent.privacy_link': 'Privacy Policy',
  'mini_apps.consent.accept': 'I agree & publish',
  'mini_apps.consent.accept_edit': 'I agree & save',
  'mini_apps.consent.decline': 'Cancel',
  'mini_apps.consent.accept_a11y': 'Agree to the content policy and continue',
  'mini_apps.consent.decline_a11y': 'Decline and cancel publishing',
  'mini_apps.consent.terms_link_a11y': 'Open Terms of Use',
  'mini_apps.consent.privacy_link_a11y': 'Open Privacy Policy',
  'mini_apps.consent.link_error': "Couldn't open the legal page. Check your connection and try again.",
  ...
  'chat_settings.message_color': 'Message color',
  ...
  'chat_settings.side_mine': 'Mine',
  'chat_settings.side_peer': 'Theirs',
  'chat_settings.default': 'Default',
  ...
  'chat_settings.scroll_button_title': 'Jump to new messages',
