// Music source API keys.
//
// Jamendo: a free, LEGAL developer API (https://devportal.jamendo.com) that
// streams FULL-LENGTH Creative-Commons / artist-licensed tracks — the same
// licensing posture as Audius, so it's App-Store-safe under §3.3.4.A.i (no
