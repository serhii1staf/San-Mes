...
- [x] 7. Fix-checking: подтвердить исправления теми же тестами из задач 1–2

  - [x] 7.1 Перезапустить exploratory-тесты на ИСПРАВЛЕННОМ коде
  ...
  - [x] 7.2 Перезапустить preservation-тесты на ИСПРАВЛЕННОМ коде
...
- [x] 8. Дополнительные unit, property-based и integration тесты (Testing Strategy)
...
- [x] 10. Финальная проверка и публикация
